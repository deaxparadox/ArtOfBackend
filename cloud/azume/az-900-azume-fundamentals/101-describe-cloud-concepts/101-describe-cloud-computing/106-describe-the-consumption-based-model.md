...
- No upfront costs.
- No need to purchase and manage costly infrastructure that uses might not use to its fullest potential.
...
[<<< Describe cloud models](103-describe-cloud-models.md) | [Describe the benefits of using cloud services >>>](../102-describe-the-benefits-of-using-cloud-services/README.md)